...
// Sign Up
export const signup = (username, email, full_name, password, re_password) => async dispatch => {
    const body = JSON.stringify({ username, email, full_name, password, re_password });
